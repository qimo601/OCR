...
#define ORIGINPOSITION_COLSUM_THRESHOLD       20				// 
#define ORIGINPOSITION_ROWSUM_THRESHOLD       20

//#define ORIGINPOSITION_COLSUM_THRESHOLD       40				// 
...
#define LIVE_IMAGEINFO2_DOT_LEN1				  18
