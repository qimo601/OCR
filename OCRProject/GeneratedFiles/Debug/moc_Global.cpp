...
void Global::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->initAcq(); break;
        case 1: _t->startAcq(); break;
        default: ;
        }
        ...
        {
            typedef void (Global::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Global::initAcq)) {
                *result = 0;
            }
        }
        {
            typedef void (Global::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Global::startAcq)) {
                *result = 1;
            }
        }
    }
