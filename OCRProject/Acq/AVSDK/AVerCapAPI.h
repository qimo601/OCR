//////////////////////////////////////////////////////////////////////////////
// (c) Copyright AVerMedia Technologies, Inc. 2013. All Rights Reserved.
//
//  Module:
//
//    AVerCapAPI.H
...
//Motion Detection
typedef BOOL (WINAPI *MotionDetectCallback)(DWORD dwID, __int64 tRefTime, BOOL bIsMotion, LPVOID lpUserData);
...
typedef struct _MOTION_DETECT_INFO
{
	...
	DWORD dwDetectID;
	BOOL  bEnableDetect;  
	DWORD dwRefFrameDistance; 
	DWORD dwNoMotionTransitionTime; 
	DWORD dwMotionBlockWidth;  
	DWORD dwMotionBlockHeight;  
	WORD  *pwMotionSensitivityMap;
	DWORD dwMapSize;
